...
**Live page:** https://shaerdan.github.io/ef-ml-seminars/ (once Pages is enabled — see below).
**Repository:** https://github.com/Shaerdan/ef-ml-seminars (private for now; to move to the org later).
